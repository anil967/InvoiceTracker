...
/**
 * GET /api/finance/messages - Get Finance User's messages
 */
export async function GET(request) {
    try {
        ...
        console.error('Error fetching finance messages:', error);
        return NextResponse.json({ error: 'Failed to fetch messages' }, { status: 500 });
    }
}

/**
 * POST /api/finance/messages - Send a message from Finance User
 */
export async function POST(request) {
    try {
        ...
        await db.createAuditTrailEntry({
            ...
            action: 'MESSAGE_SENT',
            details: `Finance message sent to ${recipient.name}: ${subject || '(no subject)'}`
        });
        ...
        console.error('Error sending finance message:', error);
        return NextResponse.json({ error: 'Failed to send message' }, { status: 500 });
    }
}

/**
 * PATCH /api/finance/messages - Mark messages as read
 */
export async function PATCH(request) {
    try {
        ...
        console.error('Error marking finance messages as read:', error);
